...
export const Route = createFileRoute("/fellowship")({
  head: () => ({
    meta: [
      { title: "FELLOWSHIP — Learn, Compete & Fly to Malaysia | NOVA" },
      {
        name: "description",
        content:
          "FELLOWSHIP is NOVA's flagship student platform: certify with leading partners, compete through judge rounds, earn a week-long Malaysia bootcamp, and launch your startup.",
      },
      { property: "og:title", content: "FELLOWSHIP — Your path to Malaysia" },
      {
        property: "og:description",
        content:
          "Learn · Certify · Compete · Travel · Build. Apply to FELLOWSHIP Edition 2026.",
      },
...
const pathSteps = [
  { n: "01", label: "Sign up", detail: "Create your FELLOWSHIP profile" },
  ...
  return (
    ...
    >
      <aside className="nexus-ticket-stub" aria-hidden="true">
        ...
        <p className="nexus-ticket-stub-flight mono">FL-26</p>
      ...
      <div className="nexus-ticket-main">
        <div className="nexus-ticket-head">
          <div className="nexus-ticket-meta-cell">
            ...
            <strong className="nexus-ticket-meta-value">FELLOWSHIP AIR</strong>
          </div>
        ...
        <footer className="nexus-ticket-foot">
          ...
          <p className="nexus-ticket-passenger">
            Passenger · FELLOWSHIP Cohort · Compete · Win · Fly
          </p>
        </footer>
      </div>
      ...
      <div className="nexus-pass-head">
        <div className="nexus-pass-head-row">
          ...
          <p className="nexus-pass-meta mono">
            7 DAYS · MY · FELLOWSHIP {nexusBatchYear}
          </p>
        </div>
...
function FellowshipPage() {
  ...
  async function onRegisterSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      await submitRegistration({ source: "fellowship", fields });
      setSent(true);
    } catch (err) {
      console.error("[fellowship register]", err);
      const msg =
  ...
  return (
    <PageShell>
      <div className="nexus-page">
        {/* ── Hero ── */}
        <section className="nexus-hero" aria-label="FELLOWSHIP hero">
        ...
        {/* ── Proof strip ── */}
        <section className="nexus-proof" aria-label="FELLOWSHIP at a glance">
          <div className="wrap">
          ...
          <div className="wrap nexus-manifesto">
            <div className="reveal">
              ...
              <div className="section-head">
                <h2>What is FELLOWSHIP?</h2>
                <p>
                  FELLOWSHIP is NOVA&apos;s flagship student platform — a single orbit from
            ...
            <ul className="nexus-keywords reveal" aria-label="FELLOWSHIP path keywords">
              <li>Learn</li>
              <li>Certify</li>
              <li>Compete</li>
              <li>Travel</li>
        ...
        <section className="section nexus-section nexus-ambient" id="path" style={{ paddingTop: 0 }}>
          ...
          <div className="wrap">
            ...
            <div className="section-head reveal">
              <h2>Your path through FELLOWSHIP</h2>
        ...
        <section className="section nexus-section nexus-ambient" id="audience" style={{ paddingTop: 0 }}>
          ...
          <div className="wrap">
            ...
            <div className="section-head reveal">
              <h2>Who it&apos;s for</h2>
              <p>
                FELLOWSHIP is open to university students across Pakistan who want to learn,
          ...
          <div className="wrap split">
            <div className="reveal">
              ...
              <p style={{ color: "var(--dim)", maxWidth: 420 }}>
                ...
                team with subject <span className="mono">NOVA-FELLOWSHIP REG</span>.
              </p>
            ...
            {sent ? (
              ...
              <form className="form-card reveal" onSubmit={onRegisterSubmit}>
                ...
                <div className="field">
                  <label htmlFor="nx-why">WHY FELLOWSHIP?</label>
                  <textarea
                    id="nx-why"
                    name="why"
                    required
                ...
                <div className="field nexus-check">
                  <label htmlFor="nx-agree">
                    ...
                    <span>I agree to be contacted by the NOVA team about FELLOWSHIP.</span>
                  </label>
                </div>
                <button className="btn btn-primary magnet" type="submit" disabled={sending}>
                  {sending ? "Sending…" : "Submit FELLOWSHIP application"}
                </button>
                {error && (
